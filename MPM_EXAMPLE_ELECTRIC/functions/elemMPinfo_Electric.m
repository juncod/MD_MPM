function [mesh,mpData] = elemMPinfo_Electric(mesh,mpData)
...
% influences.  The number of conductance matrix entries for each material
% point is determined and stored.
%
%--------------------------------------------------------------------------
% [mesh,mpData] = ELEMMPINFO_ELECTRIC(mesh,mpData)
%--------------------------------------------------------------------------
% Input(s):
...
%           - nSMe  : number conductance matrix entries for the MP
%--------------------------------------------------------------------------
% See also:
...
for mp = 1:nmp
    ...
    mpData(mp).nSMe = nn^2;                                            % number conductance matrix components
