function makeVtkMP_Electric(mpC, phi, J, mpFileName)
%Write VTK file for electric field material point data
%--------------------------------------------------------------------------
